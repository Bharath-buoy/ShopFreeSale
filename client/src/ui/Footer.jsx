	...
	return (
		<footer className="grid grid-cols-1 md:(grid-cols-3) border-t border-gray-300 bg-gray-200 px-4">
			<div className="m-4 sm:m-6 flex-1">
				...
				<p className="text-justify text-gray-700">Moderate use avoids excessive pleasure, avoids harm, and takes care to engage responsibly with desires. It is about enjoying but with boundaries, ensuring no harm comes from indulgence.</p>
			...
			<div className="m-4 sm:m-6">
				...
				<ul className="space-y-3 text-gray-700">
					<li className="flex items-center">
						...
						<span>221b MG Road Bengaluru</span>
					</li>					
					<li className="flex items-center">
